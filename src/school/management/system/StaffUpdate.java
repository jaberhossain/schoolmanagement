...
public class StaffUpdate extends JFrame{
    ...
    public StaffUpdate(){
		...
		setTitle("Update");
                ...
                setSize(1500,750);
		setLocation(0,0);   
                JLabel title = new JLabel("Staff Update");
                add(title);
               ...
               a = new JLabel("Staff ID");
               a.setBounds(450,225,300,70);
               ...
               b = new JLabel("Staff Name:");
               b.setBounds(420,175,300,70);
               b.setForeground(Color.WHITE);
               b.setBackground(Color.WHITE);
               add(b);
                bTextField = new JTextField("");
                add(bTextField);
                bTextField.setBounds(520,200, 200, 20);
            ...
            update.addActionListener(new ActionListener() {
               ...
               {
                   new Database().theQuery("UPDATE staffinfo SET name ='"+bTextField.getText()+"',password='"+hTextField.getText()+"',mobile = '"+cTextField.getText()+"',"
                           + "timming ='"+dTextField.getText()+"',place ='"+eTextField.getText()+"',salary='"+fTextField.getText()+"',"
                           + "position='"+gTextField.getText()+"'  WHERE id ='"+aTextField.getText()+"';");
                   setVisible(false);
